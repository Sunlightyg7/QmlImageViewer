...
enum Code {
    ...
    HeaderIsNull=               -9,  //!< imgMat header is NULL
    BadImageSize=              -10,  //!< imgMat size is invalid
    BadOffset=                 -11,  //!< offset is invalid
    BadDataPtr=                -12,  //!<
    BadStep=                   -13,  //!< imgMat step is wrong, this may happen for a non-continuous matrix.
    BadModelOrChSeq=           -14,  //!<
    BadNumChannels=            -15,  //!< bad number of channels, for example, some functions accept only single channel matrices.
    BadNumChannel1U=           -16,  //!<
    BadDepth=                  -17,  //!< input imgMat depth is not supported by the function
    BadAlphaChannel=           -18,  //!<
