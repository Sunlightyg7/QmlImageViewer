...
public:
    ...
    */
    ...
    /** @brief Sets the width of the imgMat for integration.
    * @param val input value.
    */
    CV_WRAP void setIntegrateWidth(int val);

    /** @brief Returns the width of the imgMat for integration.
    */
    CV_WRAP int getIntegrateWidth() const;

    /** @brief Sets the height of the imgMat for integration.
    * @param val input value.
    */
    CV_WRAP void setIntegrateHeight(int val);

    /** @brief Returns the height of the imgMat for integration.
    */
    CV_WRAP int getIntegrateHeight() const;

    /** @brief Sets the width of the raycasted imgMat, used when user does not provide it at raycast() call.
    * @param val input value.
    */
    CV_WRAP void setRaycastWidth(int val);

    /** @brief Returns the width of the raycasted imgMat, used when user does not provide it at raycast() call.
    */
    CV_WRAP int getRaycastWidth() const;

    /** @brief Sets the height of the raycasted imgMat, used when user does not provide it at raycast() call.
    * @param val input value.
    */
    CV_WRAP void setRaycastHeight(int val);

    /** @brief Returns the height of the raycasted imgMat, used when user does not provide it at raycast() call.
    */
    ...
    */
    ...
    /** @brief Sets camera intrinsics for raycast imgMat which, used when user does not provide them at raycast() call.
    * Format of input:
    * [ fx  0 cx ]
    * [  0 fy cy ]
    * [  0  0  1 ]
    ...
    */
    ...
    /** @brief Returns camera intrinsics for raycast imgMat, used when user does not provide them at raycast() call.
    * Format of output:
    * [ fx  0 cx ]
    * [  0 fy cy ]
    * [  0  0  1 ]
