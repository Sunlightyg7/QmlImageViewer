...
public:
    ...
    /** Prepare frame for odometry calculation
     * @param srcFrame frame will be prepared as src frame ("original" imgMat)
     * @param dstFrame frame will be prepared as dsr frame ("rotated" imgMat)
     */
     ...
     *
     * @param srcFrame src frame ("original" imgMat)
     * @param dstFrame dst frame ("rotated" imgMat)
     ...
     *
     * @param srcDepth source depth ("original" imgMat)
     * @param dstDepth destination depth ("rotated" imgMat)
     * @param Rt Rigid transformation, which will be calculated, in form:
     * { R_11 R_12 R_13 t_1
     *   R_21 R_22 R_23 t_2
     *   R_31 R_32 R_33 t_3
