...
/** @brief Finds lines in a binary imgMat using the standard Hough transform and get accumulator.
 *
...
void HoughLinesWithAccumulator(
        InputArray imgMat, OutputArray lines,
...
)
{
    ...
    HoughLines(imgMat, lines_acc, rho, theta, threshold, srn, stn, min_theta, max_theta);
