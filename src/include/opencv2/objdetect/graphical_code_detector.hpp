...
public:
    ...
    /** @brief Detects graphical code in imgMat and returns the quadrangle containing the code.
     @param img grayscale or color (BGR) imgMat containing (or not) graphical code.
     @param points Output vector of vertices of the minimum-area quadrangle containing the code.
     */
    CV_WRAP bool detect(InputArray img, OutputArray points) const;

    /** @brief Decodes graphical code in imgMat once it's found by the detect() method.

     Returns UTF8-encoded output string or empty string if the code cannot be decoded.
     @param img grayscale or color (BGR) imgMat containing graphical code.
     @param points Quadrangle vertices found by detect() method (or some other algorithm).
     @param straight_code The optional output imgMat containing binarized code, will be empty if not found.
     */
    ...
    /** @brief Both detects and decodes graphical code
     ...
     @param straight_code The optional output imgMat containing binarized code
     */
    CV_WRAP std::string detectAndDecode(InputArray img, OutputArray points = noArray(),
                                        OutputArray straight_code = noArray()) const;


    /** @brief Detects graphical codes in imgMat and returns the vector of the quadrangles containing the codes.
     @param img grayscale or color (BGR) imgMat containing (or not) graphical codes.
     @param points Output vector of vector of vertices of the minimum-area quadrangle containing the codes.
     */
    CV_WRAP bool detectMulti(InputArray img, OutputArray points) const;

    /** @brief Decodes graphical codes in imgMat once it's found by the detect() method.
     @param img grayscale or color (BGR) imgMat containing graphical codes.
    ...
    - If there are QR codes encoded with a Structured Append mode on the imgMat and all of them detected and decoded correctly,
