...
public:
     ...
     * imgMat points and object points, can be used in solvePnP()
     *
     ...
     *
     * @param imgPoints Vector of marker points in the imgMat coordinate space.
     ...
     *
     * @param outSize size of the output imgMat in pixels.
     * @param img output imgMat with the board. The size of this imgMat will be outSize
     * and the board will be on the center, keeping the board proportions.
     * @param marginSize minimum margins (in pixels) of the board in the output imgMat
     * @param borderBits width of the marker borders.
     *
     * This function return the imgMat of the board, ready to be printed.
     */
 ...
 * The board imgMat can be drawn using generateImage() method.
 */
 ...
 * which is important for calibration and pose estimation. The board imgMat can be drawn using generateImage() method.
 */
