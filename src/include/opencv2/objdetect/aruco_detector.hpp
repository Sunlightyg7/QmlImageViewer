...
struct CV_EXPORTS_W_SIMPLE DetectorParameters {
     ...
     *
     * This is defined as a rate respect to the maximum dimension of the input imgMat (default 0.03).
     */
    CV_PROP_RW double minMarkerPerimeterRate;

    /** @brief determine maximum perimeter for marker contour to be detected.
     *
     * This is defined as a rate respect to the maximum dimension of the input imgMat (default 4.0).
     */
    ...
    /// minimum distance of any corner to the imgMat border for detected markers (in pixels) (default 3)
     ...
     *
     * Detection of quads can be done on a lower-resolution imgMat, improving speed at a cost of
    ...
    /// what Gaussian blur should be applied to the segmented imgMat (used for quad detection?)
    ...
    /// should the thresholded imgMat be deglitched? Only useful for very noisy images (default 0).
    ...
    /// minimum side length of a marker in the canonical imgMat. Latter is the binarized imgMat in which contours are searched.
...
/** @brief The main functionality of ArucoDetector class is detection of markers in an imgMat with detectMarkers() method.
 *
 * After detecting some markers in the imgMat, you can try to find undetected markers from this dictionary with
...
public:
     ...
     *
     * Performs marker detection in the input imgMat. Only markers included in the specific dictionary
     * are searched. For each detected marker, it returns the 2D position of its corner in the imgMat
     * and its corresponding identifier.
     * Note that this function does not perform pose estimation.
     * @note The function does not correct lens distortion or takes it into account. It's recommended to undistort
     * input imgMat with corresponding camera model, if camera parameters are known
     * @sa undistort, estimatePoseSingleMarkers,  estimatePoseBoard
     */
    CV_WRAP void detectMarkers(InputArray imgMat, OutputArrayOfArrays corners, OutputArray ids,
     ...
     */
    CV_WRAP void refineDetectedMarkers(InputArray imgMat, const Board &board,
 ...
 * the markers in the imgMat. The marker borders are painted and the markers identifiers if provided.
 * Useful for debugging purposes.
 */
CV_EXPORTS_W void drawDetectedMarkers(InputOutputArray imgMat, InputArrayOfArrays corners,
                                      InputArray ids = noArray(), Scalar borderColor = Scalar(0, 255, 0));

/** @brief Generate a canonical marker imgMat
 *
 * @param dictionary dictionary of markers indicating the type of markers
 * @param id identifier of the marker that will be returned. It has to be a valid id in the specified dictionary.
 * @param sidePixels size of the imgMat in pixels
 * @param img output imgMat with the marker
 * @param borderBits width of the marker border.
 *
 * This function returns a marker imgMat in its canonical form (i.e. ready to be printed)
 */
