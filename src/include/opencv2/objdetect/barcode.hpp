...
public:
    ...
    */
    ...
    /** @brief Decodes barcode in imgMat once it's found by the detect() method.
     *
     * @param img grayscale or color (BGR) imgMat containing bar code.
     ...
     * @param img grayscale or color (BGR) imgMat containing barcode.
     ...
     *
     * By default, the detect method resizes the input imgMat to this limit if the smallest imgMat size is is greater than the threshold.
     ...
     * @param sizes box filter sizes, relative to minimum dimension of the imgMat (default [0.01, 0.03, 0.06, 0.08])
     */
