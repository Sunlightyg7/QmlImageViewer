...
public:
     ...
     * @param imgMat input imgMat necesary for corner refinement. Note that markers are not detected and
     ...
     */
    CV_WRAP void detectBoard(InputArray imgMat, OutputArray charucoCorners, OutputArray charucoIds,
     ...
     *
     * @param imgMat input imgMat necessary for corner subpixel.
     ...
     */
    CV_WRAP void detectDiamonds(InputArray imgMat, OutputArrayOfArrays diamondCorners, OutputArray diamondIds,
                                InputOutputArrayOfArrays markerCorners = noArray(),
                                InputOutputArray markerIds = noArray()) const;
protected:
 ...
 * @param imgMat input/output imgMat. It must have 1 or 3 channels. The number of channels is not
 * altered.
 ...
 */
CV_EXPORTS_W void drawDetectedCornersCharuco(InputOutputArray imgMat, InputArray charucoCorners,
 ...
 *
 * Given an array of detected diamonds, this functions draws them in the imgMat. The marker borders
 * are painted and the markers identifiers if provided.
 * Useful for debugging purposes.
 */
CV_EXPORTS_W void drawDetectedDiamonds(InputOutputArray imgMat, InputArrayOfArrays diamondCorners,
